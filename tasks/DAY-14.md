# Day 14 — Auto-configuration and starter

## Objective

Make the starter configure producer/consumer infrastructure automatically.
...
```text
feat: add Spring Boot starter auto-configuration
```
